...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"alertas.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mostrarAlerta = exports.esconderAlerta = void 0;
var esconderAlerta = function esconderAlerta() {
  var el = document.querySelector(".alerta");
  if (el) el.parentElement.removeChild(el);
};
exports.esconderAlerta = esconderAlerta;
var mostrarAlerta = function mostrarAlerta(type, msg) {
  esconderAlerta();
  var markup = "<div class=\"alerta alerta--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector("body").insertAdjacentHTML("afterbegin", markup);
  window.setTimeout(esconderAlerta, 5000);
};
exports.mostrarAlerta = mostrarAlerta;
},{}],"iniciarSesion.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.logout = exports.login = exports.crearPaciente = exports.crearDoctor = void 0;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === "exitoso") {
            (0, _alertas.mostrarAlerta)("exitoso", "Sesion Iniciada!");
        ...
        case 9:
          ...
          (0, _alertas.mostrarAlerta)("error", _context.t0.response.data.message);
        case 12:
        case "end":
...
// };
exports.login = login;
var crearDoctor = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(nombre, cedula, numeroTrabajo, telefono, nombreClinica, email, password, confirmarContrasena) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === "exitoso") {
            (0, _alertas.mostrarAlerta)("exitoso", "Registro exitoso!");
            window.setTimeout(function () {
              location.assign("/grafica");
            }, 1500);
            console.log(data);
        ...
        case 7:
          ...
          (0, _alertas.mostrarAlerta)("error", "Algo salio mal en el registro del doctor!");
        case 10:
        case "end":
  ...
  return function crearDoctor(_x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref2.apply(this, arguments);
  };
}();
exports.crearDoctor = crearDoctor;
var crearPaciente = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(nombre, email, edad, sexo, telefono) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alertas.mostrarAlerta)("error", "Algo salio mal en el registro del paciente");
        case 10:
        case "end":
  ...
  return function crearPaciente(_x11, _x12, _x13, _x14, _x15) {
...
var logout = /*#__PURE__*/function () {
  ...
  return function logout(_x16, _x17) {
    return _ref4.apply(this, arguments);
  };
}();
exports.logout = logout;
},{"axios":"../../node_modules/axios/index.js","./alertas":"alertas.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _iniciarSesion = require("./iniciarSesion");
/*eslint-disable*/

var suscrito = false;
var formInicio = document.querySelector(".form--login");
var formRegistro = document.querySelector(".form--registro");
var cerrarBoton = document.querySelector(".logout");
var formPaciente = document.querySelector(".form--paciente");
var chart = document.querySelector("#chart");
var btnLogico = document.querySelector("#btnG");
...
if (formInicio) {
  document.querySelector(".form--login"), addEventListener("submit", function (e) {
    ...
    (0, _iniciarSesion.login)(email, password);
  });
}
if (cerrarBoton) {
  console.log("cerrar");
  cerrarBoton.addEventListener("click", _iniciarSesion.logout);
}
if (chart) {
  btnLogico.addEventListener("click", function () {
...
if (formPaciente) {
  ...
  formPaciente.addEventListener("submit", function (e) {
    ...
    var telefono = document.getElementById("telP").value;
    var edad = document.getElementById("edadP").value;
    var email = document.getElementById("correoP").value;
    var sexo = document.getElementById("sexoP").value;
    (0, _iniciarSesion.crearPaciente)(nombre, email, edad, sexo, telefono);
  });
}
if (formRegistro) {
  console.log("Hola");
